	...
	public static void main(String[] args) {
		...
		String heightToRide = JOptionPane.showInputDialog("Enter your hight in inches.");
				...
				// 3) Convert heightToRide to heightAsInt using Integer.parseInt();  Hint: int heightAsInt = Integer.parse... 
					...
					if(heightAsInt >= 48) {
						JOptionPane.showMessageDialog(null, "Yay! You are tall enough to ride this coaster alone!");
					}else if(heightAsInt >= 42) {
						JOptionPane.showMessageDialog(null, "You can ride this coaster with someone else!");
					}
